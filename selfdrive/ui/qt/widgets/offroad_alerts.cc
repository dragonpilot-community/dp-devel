...
AbstractAlert::AbstractAlert(bool hasRebootBtn, QWidget *parent) : QFrame(parent) {
  ...
  QPushButton *dismiss_btn = new QPushButton(AbstractAlert::tr("Close"));
  dismiss_btn->setFixedSize(400, 125);
  footer_layout->addWidget(dismiss_btn, 0, Qt::AlignBottom | Qt::AlignLeft);
  QObject::connect(dismiss_btn, &QPushButton::clicked, this, &AbstractAlert::dismiss);

  snooze_btn = new QPushButton(AbstractAlert::tr("Snooze Update"));
  ...
  if (hasRebootBtn) {
    QPushButton *rebootBtn = new QPushButton(AbstractAlert::tr("Reboot and Update"));
