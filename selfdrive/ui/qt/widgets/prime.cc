...
PairingPopup::PairingPopup(QWidget *parent) : QDialogBase(parent) {
  ...
  hlayout->addLayout(vlayout, 1);
  {
    ...
    QLabel *title = new QLabel(PairingPopup::tr("Pair your device to your comma account"), this);
...
PrimeUserWidget::PrimeUserWidget(QWidget* parent) : QWidget(parent) {
  ...
  QLabel* subscribed = new QLabel(PrimeUserWidget::tr("✓ SUBSCRIBED"));
  ...
  QLabel* commaPrime = new QLabel(PrimeUserWidget::tr("comma prime"));
  ...
  QLabel* connectUrl = new QLabel(PrimeUserWidget::tr("CONNECT.COMMA.AI"));
  ...
  QLabel* commaPoints = new QLabel(PrimeUserWidget::tr("COMMA POINTS"));
...
PrimeAdWidget::PrimeAdWidget(QWidget* parent) : QFrame(parent) {
  ...
  QLabel *upgrade = new QLabel(PrimeAdWidget::tr("Upgrade Now"));
  upgrade->setStyleSheet("font-size: 75px; font-weight: bold;");
  main_layout->addWidget(upgrade, 0, Qt::AlignTop);
  main_layout->addSpacing(50);

  QLabel *description = new QLabel(PrimeAdWidget::tr("Become a comma prime member at connect.comma.ai"));
  ...
  QLabel *features = new QLabel(PrimeAdWidget::tr("PRIME FEATURES:"));
...
SetupWidget::SetupWidget(QWidget* parent) : QFrame(parent) {
  ...
  QLabel* registrationTitle = new QLabel(SetupWidget::tr("Finish Setup"));
  ...
  QLabel* registrationDescription = new QLabel(SetupWidget::tr("Pair your device with comma connect (connect.comma.ai) and claim your comma prime offer."));
  ...
  QPushButton* pair = new QPushButton(SetupWidget::tr("Pair device"));
