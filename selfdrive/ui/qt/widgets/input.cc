...
bool ConfirmationDialog::alert(const QString &prompt_text, QWidget *parent) {
  ConfirmationDialog d = ConfirmationDialog(prompt_text, ConfirmationDialog::tr("Ok"), "", parent);
  return d.exec();
}

bool ConfirmationDialog::confirm(const QString &prompt_text, QWidget *parent) {
  ConfirmationDialog d = ConfirmationDialog(prompt_text, ConfirmationDialog::tr("Ok"), ConfirmationDialog::tr("Cancel"), parent);
  return d.exec();
}
