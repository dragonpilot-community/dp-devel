...
ALLOWED_FINGERPRINTS = [TOYOTA.COROLLA_TSS2, TOYOTA.COROLLA, TOYOTA.COROLLAH_TSS2, TOYOTA.PRIUS_TSS2]
...
class TorqueEstimator:
  def __init__(self, CP):
    ...
    self.resets = 0.0
    self.use_params = CP.carFingerprint in ALLOWED_FINGERPRINTS or Params().get_bool('dp_lateral_torque_live_tune')
